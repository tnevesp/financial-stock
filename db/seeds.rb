...
[
	...
	['Companhia de Saneamento do Parana SANEPAR', 'SAPR11'],
	...
	['Lojas Americanas SA Preference Shares', 'LAME4'],
	['Trisul SA', 'TRIS3'],
	...
	['Grendene SA', 'GRND3'],
	['EVEN Construtora e Incorporadora SA', 'EVEN3'],
	['Banco ABC Brasil SA', 'ABCB4'],
	...
	['Vivo', 'VIVT4'],
	['EDP Energias do Brasil SA', 'ENBR3'],
	['Suzano Papel e Celulose SA', 'SUZB3'],
	['Azul SA', 'AZUL4'],
	['Itausa Investimentos Itau SA Preference Shares', 'ITSA4'],
	['Odontoprev SA', 'ODPV3'],
	['Ultrapar Participacoes SA', 'UGPA3'],
	['Via Varejo SA Brazilian Units', 'VVAR11'],
	['Banco Intermedium', 'BIDI4'],
	['Mahle-metal Leve', 'LEVE3'],
	['LPS Brasil - Consultoria de Imoveis SA', 'LPSB3'],
	['Banco Bradesco SA Preference Shares', 'BBDC4'],
	['Via Varejo SA Brazilian', 'VVAR3'],
	['Arezzo', 'ARZZ3'],
	['Lojas Marisa', 'AMAR3'],
	['Minerva Foods', 'BEEF3'],
	['Vulcabras Azaleia', 'VULC3'],
	['Petroleo Brasileiro SA Petrobras', 'PETR3'],
	['Grupo CCR', 'CCRO3'],
	['CENTAURO', 'CNTO3'],
	['Locamerica', 'LCAM3'],
	['Porto Seguro', 'PSSA3'],
	['Compania de Saneamento de Minas Gerais - COPASA MG', 'CSMG3']
].each do |nome, ticker|
